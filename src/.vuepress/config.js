...
module.exports = {
  ...
  description: 'postgresql相关知识点',
  base: '/web-postgresql/', // 部署站点的基础路径
  port: 3010,
  dest: 'web-postgresql', // 指定 vuepress 的输出目录
  markdown: {
  ...
  plugins: {
    ...
    "@vssue/vuepress-plugin-vssue": {
      ...
      repo: 'web-postgresql', //github一个项目的名称
  ...
  // 主题配置
  themeConfig: {
    repo: 'https://github.com/zhoubichuan/web-postgresql', // 源码地址
